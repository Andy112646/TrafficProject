...
public class YARNRunner implements ClientProtocol {
	...
	private boolean isJobInTerminalState(org.apache.hadoop.mapreduce.JobStatus status) {
		return status.getState() == org.apache.hadoop.mapreduce.JobStatus.State.KILLED
				|| status.getState() == org.apache.hadoop.mapreduce.JobStatus.State.FAILED
				|| status.getState() == org.apache.hadoop.mapreduce.JobStatus.State.SUCCEEDED;
	}
	...
	@Override
	public boolean killTask(org.apache.hadoop.mapreduce.TaskAttemptID arg0, boolean arg1)
			throws IOException, InterruptedException {
