...
public class RandomExtractCars {
	 ...
	 * 
	 * 
	 * ("dateHour"="2019-07-01_08","car"="京X91427")
	 * 
	 * 1、date_hour key   car
	 */
	private static JavaPairRDD<String, Row> randomExtractCarInfo(
		...
		/**
		 * key:时间段   value：car
		 * dateHourCar2DetailRDD ---- ("dateHour"="2019-08-01_08","car"="京X91427")
		 */
		JavaPairRDD<String, String> dateHourCar2DetailRDD = cameraRDD.mapToPair(new PairFunction<Row, String,String>() {
			...
			public Tuple2<String, String> call(Row row) throws Exception {
				String actionTime = row.getAs("action_time");//2019-07-06 06:18:49
				String dateHour = DateUtils.getDateHour(actionTime);//2019-07-06_06
				...
				//(dateHour=2019-07-06_06 , car=鲁xxxxx)
		 ...
		 * 相同的时间段内出现的车辆我们去重
		 * key:时间段   value：car
		 * dateHour2DetailRDD ---- ("dateHour"="2019-07-01_08","car"="京X91427")
		 */
...
//		} 
		...
		JavaPairRDD<String, String> extractCarRDD = dateHour2DetailRDD.groupByKey().flatMapToPair(
			...
			public Iterator<Tuple2<String, String>> call(Tuple2<String, Iterable<String>> t) throws Exception {
				...
				String dateHour = t._1;//2019-07-06_08
